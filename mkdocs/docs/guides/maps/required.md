...
# FoSpy JSON Map Guide - required

[Download Here.](../../file_download/FoSpy_Map_Guides/required_fields.json) If your browser does not download, save the page directly (usually with Ctrl + S).
