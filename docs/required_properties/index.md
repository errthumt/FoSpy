...
the the [templates](../../example/templates/) folder of the [API script example](../../mkdocs/docs/examples/API_example.md).
...
| Property | Validation Routine or Class | Description |
|---------|-----------------------------|-------------|
| rename | `validators.rename.rename_dict` | A dictionary of old_name:new_name pairs for renaming properties within the `SingleBlock` subclass while keeping them in sync with their validators. Refer to the [API script example](../../mkdocs/docs/examples/API_example.md) for usage.|
