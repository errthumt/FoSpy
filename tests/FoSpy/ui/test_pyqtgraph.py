...
@pytest.mark.parametrize(
    "expected",
    [
        # TODO: fill in test data for test_separator
        # pytest.param(id="")
    ]
)
def test_separator(expected):
    # TODO: create assertions for test_separator
    # FoSpy.ui.pyqtgraph._separator()
    pass
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # pytest.param(FoSpy.ui.pyqtgraph.ControlPanel(rows, parent), , expected, id="")
    ]
)
...
@pytest.mark.parametrize(
    "instance,expected",
    [
        # TODO: fill in test data for test_sliderplot_next_ctrl_row
        # pytest.param(FoSpy.ui.pyqtgraph.SliderPlot(title, specs, cfg, x_label, y_label, x_ticks, y_ticks), expected, id="")
    ]
)
def test_sliderplot_next_ctrl_row(instance, expected):
    # TODO: write test for test_sliderplot_next_ctrl_row
    # TODO: create assertions for test_sliderplot_next_ctrl_row
    # instance.next_ctrl_row()
    pass
...
@pytest.mark.parametrize(
    "instance,name,val,expected",
    [
        # TODO: fill in test data for test_sliderplot_to_slider_pos
        # pytest.param(FoSpy.ui.pyqtgraph.SliderPlot(title, specs, cfg, x_label, y_label, x_ticks, y_ticks), , , expected, id="")
    ]
)
def test_sliderplot_to_slider_pos(instance, name, val, expected):
    # TODO: write test for test_sliderplot_to_slider_pos
    # TODO: create assertions for test_sliderplot_to_slider_pos
    # instance._to_slider_pos(name, val)
    pass


@pytest.mark.parametrize(
    "instance,name,pos,expected",
    [
        # TODO: fill in test data for test_sliderplot_from_slider_pos
        # pytest.param(FoSpy.ui.pyqtgraph.SliderPlot(title, specs, cfg, x_label, y_label, x_ticks, y_ticks), , , expected, id="")
    ]
)
def test_sliderplot_from_slider_pos(instance, name, pos, expected):
    # TODO: write test for test_sliderplot_from_slider_pos
    # TODO: create assertions for test_sliderplot_from_slider_pos
    # instance._from_slider_pos(name, pos)
    pass
...
@pytest.mark.parametrize(
    "instance,spec_name,expected",
    [
        # TODO: fill in test data for test_sliderplot_check_changed
        # pytest.param(FoSpy.ui.pyqtgraph.SliderPlot(title, specs, cfg, x_label, y_label, x_ticks, y_ticks), , expected, id="")
    ]
)
def test_sliderplot_check_changed(instance, spec_name, expected):
    # TODO: write test for test_sliderplot_check_changed
    # TODO: create assertions for test_sliderplot_check_changed
    # instance._check_changed(spec_name)
    pass
...
@pytest.mark.parametrize(
    "instance,spec_name,expected",
    [
        # TODO: fill in test data for test_sliderplot_spec_for
        # pytest.param(FoSpy.ui.pyqtgraph.SliderPlot(title, specs, cfg, x_label, y_label, x_ticks, y_ticks), , expected, id="")
    ]
)
def test_sliderplot_spec_for(instance, spec_name, expected):
    # TODO: write test for test_sliderplot_spec_for
    # TODO: create assertions for test_sliderplot_spec_for
    # instance._spec_for(spec_name)
    pass
